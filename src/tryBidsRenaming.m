%try bids rename
addpath(genpath('/Users/shahzad/GitHubCodes/bids-matlab'));
% bf = bids.File(fullfile(pwd,'space-MNI_atlas-neurosynth_mask.nii'), 'use_schema', false);

bf = bids.File(fullfile(pwd,'space-MNI_label-expandVox214_mask.nii'), 'use_schema', false);
bf.entities.sub = '04';
bf = bf.reorder_entities();
bf.rename('verbose', true);
bf.rename('verbose', true, 'dry_run', false);

rmpath(genpath('/Users/shahzad/GitHubCodes/bids-matlab'))
